...
@RestController
@RequestMapping("/api")
public class EmployeeJobResource {

    private final Logger log = LoggerFactory.getLogger(EmployeeJobResource.class);
    ...
    public EmployeeJobResource(EmployeeRepository employeeRepository, EmployeeMapper employeeMapper) {
